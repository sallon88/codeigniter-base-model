...
class PHPExcel
{
	...
	*/
	...
	public static function export($data, $headings = array(), $filename = 'export-xls')
	{
		// Create new PHPExcel object
		$objPHPExcel = new self();

		// Set document properties
		$objPHPExcel->getProperties()->setCreator("GeekPark")
									 ->setLastModifiedBy("GeekPark")
									 ->setTitle("GeekPark XLS Document")
									 ->setSubject("GeekPark XLS Document")
									 ->setDescription("GeekPark XLS, generated using PHP classes.")
									 ->setKeywords("GeekPark XLS")
									 ->setCategory("GeekPark XLS");
		...
		if ($headings)
		{
			$activeSheet->getPageSetup()->setRowsToRepeatAtTopByStartAndEnd(1, 1);
			$activeSheet->freezePane('A2');
			$activeSheet->fromArray($headings, NULL, 'A1');
			$topleft = 'A2';
		}

		$activeSheet->fromArray($data, NULL, $topleft);
